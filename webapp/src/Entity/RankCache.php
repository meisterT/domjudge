 ...
 */
#[ORM\Table(name: 'rankcache', options: ['collation' => 'utf8mb4_unicode_ci', 'charset' => 'utf8mb4', 'comment' => 'Scoreboard rank cache'])]
...
class RankCache
{
    #[ORM\Column(type: 'integer', name: 'points_restricted', length: 4, options: ['comment' => 'Total correctness points (restricted audience)', 'unsigned' => true, 'default' => 0], nullable: false)]
    private int $points_restricted = 0;

    #[ORM\Column(type: 'integer', name: 'totaltime_restricted', length: 4, options: ['comment' => 'Total penalty time in minutes (restricted audience)', 'default' => 0], nullable: false)]
    private int $totaltime_restricted = 0;

    #[ORM\Column(type: 'integer', name: 'totalruntime_restricted', length: 4, options: ['comment' => 'Total runtime in milliseconds (restricted audience)', 'default' => 0], nullable: false)]
    private int $totalruntime_restricted = 0;

    #[ORM\Column(type: 'integer', name: 'points_public', length: 4, options: ['comment' => 'Total correctness points (public)', 'unsigned' => true, 'default' => 0], nullable: false)]
    private int $points_public = 0;

    #[ORM\Column(type: 'integer', name: 'totaltime_public', length: 4, options: ['comment' => 'Total penalty time in minutes (public)', 'default' => 0], nullable: false)]
    private int $totaltime_public = 0;

    #[ORM\Column(type: 'integer', name: 'totalruntime_public', length: 4, options: ['comment' => 'Total runtime in milliseconds (public)', 'default' => 0], nullable: false)]
