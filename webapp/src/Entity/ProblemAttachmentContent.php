...
#[ORM\Table(name: 'problem_attachment_content', options: ['collation' => 'utf8mb4_unicode_ci', 'charset' => 'utf8mb4', 'comment' => 'Stores contents of problem attachments'])]
#[ORM\Entity]
class ProblemAttachmentContent
{
    ...
    #[ORM\Column(type: 'blobtext', length: 4294967295, name: 'content', options: ['comment' => 'Attachment content'])]
