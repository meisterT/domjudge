 ...
 * )
 */
#[ORM\Table(name: 'contest', options: ['collation' => 'utf8mb4_unicode_ci', 'charset' => 'utf8mb4', 'comment' => 'Contests that will be run with this install'])]
...
class Contest extends BaseApiEntity implements AssetEntityInterface
{
     ...
     * @Serializer\Exclude()
     */
    #[ORM\Column(type: 'boolean', name: 'starttime_enabled', options: ['comment' => 'If disabled, starttime is not used, e.g. to delay contest start', 'default' => 1], nullable: false)]
     ...
     * @Serializer\Exclude()
     */
    #[ORM\Column(type: 'text', name: 'finalizecomment', length: 65535, options: ['comment' => 'Comments by the finalizer'], nullable: true)]
    private ?string $finalizecomment = null;

    /**
     * @Serializer\Exclude()
     */
    #[ORM\Column(type: 'smallint', length: 3, name: 'b', options: ['comment' => 'Number of extra bronze medals', 'unsigned' => true, 'default' => 0], nullable: false)]
    private ?int $b = 0;

    /**
     * @Serializer\Exclude()
     */
    #[ORM\Column(type: 'boolean', name: 'medals_enabled', options: ['default' => 0], nullable: false)]
    ...
    #[ORM\ManyToMany(targetEntity: \App\Entity\TeamCategory::class, inversedBy: 'contests_for_medals')]
    private Collection $medal_categories;

    /**
     * @Serializer\Exclude()
     */
    #[ORM\Column(type: 'smallint', length: 3, name: 'gold_medals', options: ['comment' => 'Number of gold medals', 'unsigned' => true, 'default' => 4], nullable: false)]
    private int $goldMedals = 4;

    /**
     * @Serializer\Exclude()
     */
    #[ORM\Column(type: 'smallint', length: 3, name: 'silver_medals', options: ['comment' => 'Number of silver medals', 'unsigned' => true, 'default' => 4], nullable: false)]
    private int $silverMedals = 4;

    /**
     * @Serializer\Exclude()
     */
    #[ORM\Column(type: 'smallint', length: 3, name: 'bronze_medals', options: ['comment' => 'Number of bronze medals', 'unsigned' => true, 'default' => 4], nullable: false)]
     ...
     * @Serializer\Exclude()
     */
    #[ORM\Column(type: 'boolean', name: 'enabled', options: ['comment' => 'Whether this contest can be active', 'default' => 1], nullable: false)]
    private bool $enabled = true;

    /**
     * @Serializer\Groups({"Nonstrict"})
     */
    #[ORM\Column(type: 'boolean', name: 'allow_submit', options: ['comment' => 'Are submissions accepted in this contest?', 'default' => 1], nullable: false)]
    private bool $allowSubmit = true;

    /**
     * @Serializer\Exclude()
     */
    #[ORM\Column(type: 'boolean', name: 'process_balloons', options: ['comment' => 'Will balloons be processed for this contest?', 'default' => 1], nullable: false)]
    private bool $processBalloons = true;

    /**
     * @Serializer\Groups({"Nonstrict"})
     */
    #[ORM\Column(type: 'boolean', name: 'runtime_as_score_tiebreaker', options: ['comment' => 'Is runtime used as tiebreaker instead of penalty?', 'default' => 0], nullable: false)]
    private bool $runtime_as_score_tiebreaker = false;

    /**
     * @Serializer\Exclude()
     */
    #[ORM\Column(type: 'boolean', name: 'public', options: ['comment' => 'Is this contest visible for the public?', 'default' => 1], nullable: false)]
     ...
     * @Serializer\Exclude()
     */
    #[ORM\Column(type: 'boolean', name: 'open_to_all_teams', options: ['comment' => 'Is this contest open to all teams?', 'default' => 1], nullable: false)]
     ...
     */
    #[ORM\Column(type: 'text', length: 65535, name: 'warning_message', options: ['comment' => 'Warning message for this contest shown on the scoreboards'], nullable: true)]
    private ?string $warningMessage = null;

    /**
     * @Serializer\Exclude()
     */
    #[ORM\Column(type: 'boolean', name: 'is_locked', options: ['comment' => 'Is this contest locked for modifications?', 'default' => 0], nullable: false)]
    ...
    #[ORM\JoinColumn(name: 'cid', referencedColumnName: 'cid', onDelete: 'CASCADE')]
    #[ORM\InverseJoinColumn(name: 'categoryid', referencedColumnName: 'categoryid', onDelete: 'CASCADE')]
    #[ORM\ManyToMany(targetEntity: \App\Entity\TeamCategory::class, inversedBy: 'contests')]
     ...
     * @Serializer\Exclude()
     */
    #[ORM\OneToMany(targetEntity: \App\Entity\RemovedInterval::class, mappedBy: 'contest')]
    #[Assert\Valid]
     ...
     * @Serializer\Exclude()
     */
    #[ORM\OneToMany(targetEntity: \App\Entity\ExternalContestSource::class, mappedBy: 'contest')]
    #[Assert\Valid]
