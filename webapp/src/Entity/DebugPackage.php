 ...
 */
#[ORM\Table(name: 'debug_package', options: ['collation' => 'utf8mb4_unicode_ci', 'charset' => 'utf8mb4', 'comment' => 'Debug packages.'])]
...
class DebugPackage
{
    ...
    #[ORM\Column(type: 'integer', name: 'debug_package_id', length: 4, options: ['comment' => 'Debug Package ID', 'unsigned' => true], nullable: false)]
     ...
     * @var string
     */
    #[ORM\Column(type: 'string', name: 'filename', length: 255, options: ['comment' => 'Name of the file where we stored the debug package.'], nullable: false)]
