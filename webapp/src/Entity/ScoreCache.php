 ...
 * Scoreboard cache.
 */
#[ORM\Table(name: 'scorecache', options: ['collation' => 'utf8mb4_unicode_ci', 'charset' => 'utf8mb4', 'comment' => 'Scoreboard cache'])]
...
class ScoreCache
{
    #[ORM\Column(type: 'integer', name: 'submissions_restricted', length: 4, options: ['comment' => 'Number of submissions made (restricted audiences)', 'unsigned' => true, 'default' => 0], nullable: false)]
    private int $submissions_restricted = 0;

    #[ORM\Column(type: 'integer', name: 'pending_restricted', length: 4, options: ['comment' => 'Number of submissions pending judgement (restricted audience)', 'unsigned' => true, 'default' => 0], nullable: false)]
    private int $pending_restricted = 0;

    #[ORM\Column(type: 'boolean', name: 'is_correct_restricted', options: ['comment' => 'Has there been a correct submission? (restricted audience)', 'default' => 0], nullable: false)]
    private bool $is_correct_restricted = false;

    /**
     * @var double|string
     */
    #[ORM\Column(type: 'decimal', precision: 32, scale: 9, name: 'solvetime_restricted', options: ['comment' => 'Seconds into contest when problem solved (restricted audience)', 'default' => '0.000000000'], nullable: false)]
    private $solvetime_restricted = 0;

    #[ORM\Column(type: 'integer', name: 'runtime_restricted', length: 4, options: ['comment' => 'Runtime in milliseconds (restricted audience)', 'default' => 0], nullable: false)]
    private int $runtime_restricted = 0;

    #[ORM\Column(type: 'integer', name: 'submissions_public', length: 4, options: ['comment' => 'Number of submissions made (public)', 'unsigned' => true, 'default' => 0], nullable: false)]
    private int $submissions_public = 0;

    #[ORM\Column(type: 'integer', name: 'pending_public', length: 4, options: ['comment' => 'Number of submissions pending judgement (public)', 'unsigned' => true, 'default' => 0], nullable: false)]
    private int $pending_public = 0;

    #[ORM\Column(type: 'boolean', name: 'is_correct_public', options: ['comment' => 'Has there been a correct submission? (public)', 'default' => 0], nullable: false)]
    private bool $is_correct_public = false;

    /**
     * @var double|string
     */
    #[ORM\Column(type: 'decimal', precision: 32, scale: 9, name: 'solvetime_public', options: ['comment' => 'Seconds into contest when problem solved (public)', 'default' => '0.000000000'], nullable: false)]
    private $solvetime_public = 0;

    #[ORM\Column(type: 'integer', name: 'runtime_public', length: 4, options: ['comment' => 'Runtime in milliseconds (public)', 'default' => 0], nullable: false)]
    private int $runtime_public = 0;

    #[ORM\Column(type: 'boolean', name: 'is_first_to_solve', options: ['comment' => 'Is this the first solution to this problem?', 'default' => 0], nullable: false)]
