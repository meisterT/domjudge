 ...
 * )
 */
#[ORM\Table(name: 'team_category', options: ['collation' => 'utf8mb4_unicode_ci', 'charset' => 'utf8mb4', 'comment' => 'Categories for teams (e.g.: participants, observers, ...)'])]
...
class TeamCategory extends BaseApiEntity implements Stringable
{
    ...
    #[ORM\Column(type: 'integer', name: 'categoryid', length: 4, options: ['comment' => 'Team category ID', 'unsigned' => true], nullable: false)]
    protected ?int $categoryid = null;

    /**
     * @Serializer\Exclude()
     */
    #[ORM\Column(type: 'string', name: 'externalid', length: 255, options: ['comment' => 'Team category ID in an external system', 'collation' => 'utf8mb4_bin'], nullable: true)]
     ...
     */
    #[ORM\Column(type: 'string', name: 'icpcid', length: 255, options: ['comment' => 'External identifier from ICPC CMS', 'collation' => 'utf8mb4_bin'], nullable: true)]
     ...
     */
    #[ORM\Column(type: 'tinyint', name: 'sortorder', options: ['comment' => 'Where to sort this category on the scoreboard', 'unsigned' => true, 'default' => 0], nullable: false)]
     ...
     * @Serializer\Exclude()
     */
    #[ORM\Column(type: 'boolean', name: 'visible', options: ['comment' => 'Are teams in this category visible?', 'default' => 1], nullable: false)]
    private bool $visible = true;

    /**
     * @Serializer\Exclude()
     */
    #[ORM\Column(type: 'boolean', name: 'allow_self_registration', options: ['comment' => 'Are self-registered teams allowed to choose this category?', 'default' => 0], nullable: false)]
