 ...
 */
#[ORM\Table(name: 'external_run', options: ['collation' => 'utf8mb4_unicode_ci', 'charset' => 'utf8mb4', 'comment' => 'Run in external system'])]
...
class ExternalRun
{
    ...
    #[ORM\Column(type: 'integer', name: 'extrunid', length: 4, options: ['comment' => 'External run ID', 'unsigned' => true], nullable: false)]
    ...
    #[ORM\Column(name: 'result', type: 'string', length: 32, options: ['comment' => 'Result string as obtained from external system'], nullable: false)]
    private string $result;

    #[ORM\Column(type: 'decimal', precision: 32, scale: 9, name: 'endtime', options: ['comment' => 'Time run ended', 'unsigned' => true], nullable: false)]
    private string|float $endtime;

    #[ORM\Column(type: 'float', name: 'runtime', options: ['comment' => 'Running time on this testcase'], nullable: false)]
