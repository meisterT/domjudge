...
#[ORM\Table(name: 'external_source_warning', options: ['collation' => 'utf8mb4_unicode_ci', 'charset' => 'utf8mb4', 'comment' => 'Warnings for external sources'])]
...
class ExternalSourceWarning
{
    ...
    #[ORM\Column(type: 'integer', name: 'extwarningid', options: ['comment' => 'External source warning ID', 'unsigned' => true], nullable: false, length: 4)]
    private ?int $extwarningid = null;

    #[ORM\Column(type: 'string', name: 'last_event_id', length: 255, options: ['comment' => 'Last event ID this warning happened at'], nullable: true)]
    private ?string $lastEventId = null;

    #[ORM\Column(type: 'decimal', precision: 32, scale: 9, name: 'time', options: ['comment' => 'Time this warning happened last', 'unsigned' => true], nullable: false)]
    private float $lastTime;

    #[ORM\Column(type: 'string', name: 'entity_type', length: 255, options: ['comment' => 'Type of the entity for this warning'], nullable: false)]
    private string $entityType;

    #[ORM\Column(type: 'string', name: 'entity_id', length: 255, options: ['comment' => 'ID of the entity for this warning'], nullable: false)]
    private string $entityId;

    #[ORM\Column(type: 'string', name: 'type', length: 255, options: ['comment' => 'Type of this warning'], nullable: false)]
    private string $type;

    #[ORM\Column(type: 'string', name: 'hash', length: 255, options: ['comment' => 'Hash of this warning. Unique within the source.'], nullable: false)]
    private string $hash;

    #[ORM\Column(name: 'content', type: 'json', options: ['comment' => 'JSON encoded content of the warning. Type-specific.'])]
