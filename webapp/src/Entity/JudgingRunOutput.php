 ...
 */
#[ORM\Table(name: 'judging_run_output', options: ['collation' => 'utf8mb4_unicode_ci', 'charset' => 'utf8mb4', 'comment' => 'Stores output of judging run'])]
...
class JudgingRunOutput
{
     ...
     */
    #[ORM\Id]
    #[ORM\ManyToOne(targetEntity: \App\Entity\JudgingRun::class, inversedBy: 'output')]
    #[ORM\JoinColumn(name: 'runid', referencedColumnName: 'runid', onDelete: 'CASCADE')]
    private JudgingRun $run;

    #[ORM\Column(type: 'blobtext', length: 4294967295, name: 'output_run', options: ['comment' => 'Output of running the program'], nullable: true)]
    private ?string $output_run = null;

    #[ORM\Column(type: 'blobtext', length: 4294967295, name: 'output_diff', options: ['comment' => 'Diffing the program output and testcase output'], nullable: true)]
    private ?string $output_diff = null;

    #[ORM\Column(type: 'blobtext', length: 4294967295, name: 'output_error', options: ['comment' => 'Standard error output of the program'], nullable: true)]
    private ?string $output_error = null;

    #[ORM\Column(type: 'blobtext', length: 4294967295, name: 'output_system', options: ['comment' => 'Judging system output'], nullable: true)]
    private ?string $output_system = null;

    #[ORM\Column(type: 'blobtext', length: 4294967295, name: 'metadata', options: ['comment' => 'Judging metadata'], nullable: true)]
