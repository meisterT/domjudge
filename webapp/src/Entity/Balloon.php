 ...
 */
#[ORM\Table(name: 'balloon', options: ['collation' => 'utf8mb4_unicode_ci', 'charset' => 'utf8mb4', 'comment' => 'Balloons to be handed out'])]
...
class Balloon
{
    ...
    #[ORM\Column(type: 'integer', length: 4, name: 'balloonid', options: ['comment' => 'Balloon ID', 'unsigned' => true], nullable: false)]
    private int $balloonid;

    #[ORM\Column(type: 'boolean', name: 'done', options: ['comment' => 'Has been handed out yet?', 'default' => 0], nullable: false)]
