 ...
 */
#[ORM\Table(name: 'judgehost', options: ['collation' => 'utf8mb4_unicode_ci', 'charset' => 'utf8mb4', 'comment' => 'Hostnames of the autojudgers'])]
...
class Judgehost
{
    ...
    #[ORM\Column(type: 'integer', name: 'judgehostid', length: 4, options: ['comment' => 'Judgehost ID', 'unsigned' => true], nullable: false)]
    ...
    #[ORM\Column(type: 'boolean', name: 'enabled', options: ['comment' => 'Should this host take on judgings?', 'default' => 1], nullable: false)]
    ...
    #[ORM\Column(type: 'boolean', name: 'hidden', options: ['comment' => 'Should this host be hidden in the overview?', 'default' => 0], nullable: false)]
