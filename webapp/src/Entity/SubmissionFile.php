 ...
 */
#[ORM\Table(name: 'submission_file', options: ['collation' => 'utf8mb4_unicode_ci', 'charset' => 'utf8mb4', 'comment' => 'Files associated to a submission'])]
...
class SubmissionFile
{
    ...
    #[ORM\Column(type: 'integer', name: 'submitfileid', length: 4, options: ['comment' => 'Submission file ID', 'unsigned' => true], nullable: false)]
    ...
    #[ORM\Column(type: 'integer', name: 'ranknumber', options: ['comment' => 'Order of the submission files, zero-indexed', 'unsigned' => true], nullable: false)]
    ...
    #[ORM\Column(type: 'blobtext', name: 'sourcecode', length: 4294967295, options: ['comment' => 'Full source code'], nullable: false)]
