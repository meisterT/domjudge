...
$GAINROOT "$RUNGUARD" ${DEBUG:+-v} $CPUSET_OPT -u "$RUNUSER" -g "$RUNGROUP" \
	...
	-V DJ_COMPILER_CMD="$DJ_COMPILER_CMD" -V DJ_RUNNER_CMD="$DJ_RUNNER_CMD" \
	-V DJ_COMPILER_PRE_FILES_ARGS="$DJ_COMPILER_PRE_FILES_ARGS" -V DJ_COMPILER_POST_FILES_ARGS="$DJ_COMPILER_POST_FILES_ARGS" \
	-V DJ_RUNNER_PRE_FILES_ARGS="$DJ_RUNNER_PRE_FILES_ARGS" -V DJ_RUNNER_POST_FILES_ARGS="$DJ_RUNNER_POST_FILES_ARGS" -- \
